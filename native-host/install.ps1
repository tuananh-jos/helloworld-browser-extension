...
Write-Host "  1. Mo Visual Studio -> uwp-app\HelloPasswordUwp.sln -> Deploy"
Write-Host "  2. Lay PackageFamilyName:"
Write-Host "     Get-AppxPackage -Name HelloPasswordUwp | Select-Object PackageFamilyName"
Write-Host "  3. Dien PFN vao PACKAGE_FAMILY_NAME trong Program.cs"
Write-Host "  4. Chay lai install.ps1 de rebuild native host"
Write-Host "  5. Mo UWP app, vao chrome://extensions -> Reload extension"
Write-Host "  6. Mo popup -> click [Win32 App] -> click Ping"
Write-Host "  7. UWP hien thi log, extension hien thi UWP_PONG"
Write-Host ""
